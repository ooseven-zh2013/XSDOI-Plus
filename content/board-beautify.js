...
(function () {
  ...
  function buildCSS(alpha, enabled) {
    ...
    rules.push(
      '.el-card, #nav, .oj-topbar, .el-tabs__nav-wrap, .el-tabs--border-card, .description-body, .ledger-sum, .el-table, .fix-to-bottom, .group-card, .step-card, .hero-input-wrap, .coach-hero, .cross-banner, .level-card, .el-select-dropdown, .auto-backup-dropdown, .el-popover, .el-dropdown-menu, .el-backtop, .uh-hero, .series-strip, .th-hero, .lv-card, .lv-banner, .lv-mock, .lv-season, .lv-train-card, .co-card, .goods-card, .shop-hero, .training-card, .hero, .pathway-inner, .ws-hero, .ws-card, .ws-how-item, .glossary-card, .help-section, .dimension-card, .rated-card, .hub-tab, .help-nav-item, .rating-adjust-card, .help-toc, .tier-card, .rating-tier-card, .compact-status, .score-formula, .credit-note, .help-callout, .easter-egg, .exam-hero, .exam-card, .el-dialog, .el-message-box, .cc-card, .ai-banner, .m-message, .el-tag--dark.el-popover__reference, .el-input__count, .el-input__count-inner, [data-backup-panel="1"] {',
    ...
    if (enabled) {
      rules.push(
        '.el-card, #nav, .oj-topbar, .el-tabs__nav-wrap, .el-tabs--border-card, .ledger-sum, .el-table, .fix-to-bottom, .group-card, .step-card, .hero-input-wrap, .coach-hero, .cross-banner, .level-card, .el-select-dropdown, .auto-backup-dropdown, .font-dropdown, .el-dropdown-menu, .el-backtop, .uh-hero, .series-strip, .th-hero, .lv-card, .lv-banner, .lv-mock, .lv-season, .lv-train-card, .co-card, .goods-card, .shop-hero, .training-card, .hero, .pathway-inner, .ws-hero, .ws-card, .ws-how-item, .glossary-card, .help-section, .dimension-card, .rated-card, .hub-tab, .help-nav-item, .rating-adjust-card, .status-card, .help-hero, .help-toc, .tier-card, .rating-tier-card, .compact-status, .score-formula, .credit-note, .help-callout, .easter-egg, .exam-hero, .exam-card, .el-dialog, .el-message-box, .cc-card, .m-message, .el-tag--dark.el-popover__reference, .el-input__count, .el-input__count-inner, [data-backup-panel="1"] {',
