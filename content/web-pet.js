...
(function () {
  ...
  var CSS_TEXT = [
    ...
    '#xsdoi-deepseek-overlay .xsdoi-ds-reasoning{align-self:stretch;max-width:92%;margin:2px 0 6px;min-height:34px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.08);border-radius:8px;font-size:13px;}',
    ...
    '#xsdoi-deepseek-overlay .xsdoi-ds-reasoning-body{display:block;padding:8px 12px 10px;color:rgba(255,255,255,0.72);font-size:13px;max-height:320px;overflow-y:auto;line-height:1.6;white-space:pre-wrap;word-break:break-word;}',
