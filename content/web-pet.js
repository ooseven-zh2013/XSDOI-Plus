...
(function () {
  ...
  var CSS_TEXT = [
    ...
    '#xsdoi-deepseek-overlay .xsdoi-ds-reasoning{display:block;flex-shrink:0;align-self:flex-start;max-width:92%;margin:6px 0;min-height:34px;background:rgba(255,255,255,0.20);border:1px solid rgba(255,255,255,0.30);border-radius:10px;font-size:13px;}',
    '#xsdoi-deepseek-overlay .xsdoi-ds-reasoning>summary{list-style:none;cursor:pointer;padding:8px 12px;color:rgba(255,255,255,0.65);user-select:none;display:flex;align-items:center;gap:6px;border-bottom:1px solid rgba(255,255,255,0.08);font-size:13px;}',
    ...
    '#xsdoi-deepseek-overlay .xsdoi-ds-reasoning-body{display:block;padding:8px 12px 10px;color:rgba(255,255,255,0.72);font-size:13px;line-height:1.6;white-space:pre-wrap;word-break:break-word;}',
